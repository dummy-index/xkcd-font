...
U.cv01 N A U T H O R I T A T I V E N E S S   L EA T H.cv01 E R B A R K   I N T R A CO L I C   M I CR OCH E L I A
O F F S I D ER   G LA S S W EE D   R O TT O L O   A LB E R T I.cv01 T E   H ER M A T O RR H A C H I S
O R G A N O M E T A LL I C   S E G R E G A T I.sc ON I S T   U N E V A N G E L I C   CA M PS TO O L
+ − × * ! ? # @ $ % ¦ & ^ _ — – - ( ) [ ] { } / \ < > ÷ ± √ Σ
...
for line_no, line in enumerate(characters_by_line):
    for char_no, char, bbox, img in line:
        ...
        if sys.version_info.major == 2:
            b64_repr = char.encode('base64').rstrip()
        else:
